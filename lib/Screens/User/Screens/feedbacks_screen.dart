...
class FeedbacksScreen extends StatelessWidget {
          ...
          return Scaffold(
            ...
            body: ListView(
              children: [
                ...
                ...reviews.map((review) => _buildReviewBox(context, review)),
              ],
            ),
          );
        }
  ...
  Widget _buildDishHeader(BuildContext context, DishItemViewModel? dish) {
    return Container(
      ...
      margin: EdgeInsets.all(AppSize.widthSize(10, context)),
  ...
  Widget _buildReviewBox(BuildContext context, DishReviewItemViewModel review) {
    return Container(
      margin: EdgeInsets.all(AppSize.widthSize(20, context)),
      padding: EdgeInsets.all(AppSize.widthSize(12, context)),
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(AppSize.widthSize(24, context)),
        color: Provider.of<AppSettingsProvider>(context).isDark
            ? AppColors.darkContainerBackground
